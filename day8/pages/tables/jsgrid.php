...
// Mengambil data dari tabel clients
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="#" class="d-block">I Love Shollakhuddin Kurniawan</a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . ($row['Married'] ? 'Menikah' : 'Belum Menikah') . "</td>";
                                            echo "<td><a href='detail_client.php?id=" . $row['id'] . "' class='btn btn-info'>Detail</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
